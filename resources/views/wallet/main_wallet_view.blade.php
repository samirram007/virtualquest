                                ...
                                <div class="card-statistic-3 p-4">
                                    ...
                                    <div class="row align-items-center mb-2 d-flex">
                                        ...
                                        <div class="col-4 text-right">
                                            <span>{{ __('$') . substr(number_format($rld_amount,4,".",""),0,-2) }}</span>
                                        </div>
                                    </div>
                                    <div class="row align-items-center mb-2 d-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="col-4 text-right">
                                            <span>{{ __('$') . substr(number_format($pps_amount,4,".",""),0,-2) }}</span>
                                        </div>
                                    </div>
                                    <div class="row align-items-center mb-2 d-flex">
                                        <div class="col-8">
                                        ...
                                        <div class="col-4 text-right">
                                            <span>{{ __('$') . substr(number_format($ppsl_amount,4,".",""),0,-2) }}</span>
                                        </div>
                                    </div>
                                    <div
            ...
            Swal.fire({
                ...
                confirmButtonText: 'Confirm'
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('payment_request.process_new') }}",
                            type: "POST",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "amount": amount,
