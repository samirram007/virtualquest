...
<div class="title text-light">MPS36</div>
    <div class="btn-group">
        <button type="button" class="btn btn-outline-info"><a class="text-light" href="{{ route('admin.mps36') }}">New <span class="sr-only">(current)</span></a></button>
        <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="sr-only">Toggle Dropdown</span>
        </button>
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="{{ route('admin.mps36_all') }}">All</a>
            <a class="dropdown-item" href="{{ route('admin.mps36_index') }}">Acknowledged</a>
