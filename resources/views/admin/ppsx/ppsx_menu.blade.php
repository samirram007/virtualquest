...
<div class="title text-light">PPS NEXT</div>
    <div class="btn-group">
        <button type="button" class="btn btn-outline-info"><a class="text-light" href="{{ route('admin.ppsx') }}">New <span class="sr-only">(current)</span></a></button>
        <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="sr-only">Toggle Dropdown</span>
        </button>
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="{{ route('admin.ppsx_all') }}">All</a>
            <a class="dropdown-item" href="{{ route('admin.ppsx_index') }}">Acknowledged</a>
          <a class="dropdown-item" href="{{ route('admin.ppsx_pending') }}">Pending <span class="sr-only">(current)</span></a>
