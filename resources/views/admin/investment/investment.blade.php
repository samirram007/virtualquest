...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center p-3">
            <div class="col-md-12 ">
                <div class="row">
                    @include('admin.investment.investment_menu')
                </div>
                <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <a href="javascript:"
                                                        class="validate btn btn-info rounded-0 border border-info">Confirm</a>
                                                </div>
                                                @error('user_code')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.validate').click(function() {
                ...
                $.ajax({
                    url: "{{ route('admin.investment.user_validate') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        user_code: user_code
            ...
            $('.submit').click(function() {
                const link = "{{ route('admin.investment') }}";
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.investment.store') }}",
                            type: "POST",
                            data: {
                                _token: "{{ csrf_token() }}",
                                user_id: user_id,
