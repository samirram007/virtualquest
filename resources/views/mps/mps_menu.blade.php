...
<div class="title text-light">MPS</div>
    <div class="btn-group d-none">
        <button type="button" class="btn btn-outline-info"><a class="text-light" href="{{ route('mps.index') }}">New <span class="sr-only">(current)</span></a></button>
        <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="sr-only">Toggle Dropdown</span>
        </button>
        <div class="dropdown-menu dropdown-menu-right">
            {{-- <a class="dropdown-item" href="{{ route('mps.mps_all') }}">All</a>
            <a class="dropdown-item" href="{{ route('admin.mps_index') }}">Confirm</a>
          <a class="dropdown-item" href="{{ route('admin.mps_pending') }}">Pending <span class="sr-only">(current)</span></a>
          <a class="dropdown-item" href="{{ route('admin.mps_reject') }}">Reject <span class="sr-only">(current)</span></a> --}}
