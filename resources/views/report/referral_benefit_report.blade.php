            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="bg-secondary rounded p-4">
                        ...
                        <div>
                            <form id="transfer_form" method="POST" action="{{route('rld_transfer.wallet')}}" >
                                @csrf
                                ...
                                @if($balance>1)
                                <button type="submit"  class="d-flex btn btn-dark btn-block text-center {{ $balance<0.0001 ? 'disabled':''}}">Transfer ${{ substr(number_format($balance,4,'.',''),0,-2) }} To Main Wallet</button>
                                @else
                        ...
                        <table class="table table-dark">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right">${{ substr(number_format($collection->sum('amount'),4,'.',''),0,-2) }}</th>
                                    <th></th>
